...
import com.techeeresc.tab.domain.member.dto.request.TokenDto;
import com.techeeresc.tab.global.security.jwt.JwtFilter;
...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody MemberLoginRequestDto memberLoginRequestDto) {
