...
@Service
public class ShareInfoServiceImpl implements ShareInfoService, ShareInfoQueryDslRepository {
  ...
  private ShareInfo isShareInfoExisted(Long id) {
    ShareInfo shareInfo = REPOSITORY.findById(id).orElseThrow(() -> new NullPointerException());
