...
public class ShareInfoMapper {
    public ShareInfo ToEntity(ShareInfoCreateRequestDto shareInfoCreateRequestDto) {  //Entity를 저장하는 방식
    ...
    public ShareInfoCreateRequestDto fromEntity(ShareInfo shareInfo) {    //Entity로 부터 값을 받아오는 방식이다.
